...
export class CanonError extends ReceiptError {
  constructor(message?: string, code = "noncanonical_value") {
    super(message, code);
...
export class ShapeError extends ReceiptError {
  constructor(message?: string, code = "invalid_shape") {
    super(message, code);
...
export class GraphError extends ReceiptError {
  constructor(message?: string, code = "invalid_graph") {
    super(message, code);
...
export class SchemaError extends ReceiptError {
  constructor(message?: string, code = "unsupported_schema") {
    super(message, code);
...
export class SignatureError extends ReceiptError {
  constructor(message?: string, code = "invalid_signature") {
    super(message, code);
