...
> An x402-paywalled AI oracle for prediction markets. Every price ships with a hashed reasoning trace settled on Arc in <1 s for ~$0.01.
...
Python 3.11+ (FastAPI, anthropic SDK, web3.py, SQLAlchemy 2.0), Solidity 0.8.26 (Foundry), TypeScript / Next.js 15 / Tailwind / Recharts, Arc testnet, Circle Wallets (developer-controlled), Circle Nanopayments, x402, Polymarket Gamma + CLOB, Irys.
